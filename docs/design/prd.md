...
**Autor:** Alex Santolaria (consultor técnico)
...
> **Importante:** Estas preguntas requieren respuesta de la CEO antes de generar tickets de desarrollo. Algunas afectan a la arquitectura técnica y a las métricas. Recomendación: agruparlas en una conversación única para evitar fragmentación.
