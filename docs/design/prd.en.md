...
**Author:** Alex Santolaria (technical consultant) + Maia (Flora · Forrest · Iris · Spark · Melody)
...
> Mandatory section in every PRD per Flora's convention: *"How will we know this is actually done — not just reported as done?"*
...
> **Important:** These questions need a CEO answer before closing pipeline Phase 4 (`/hive:plan` for tickets). Some affect architecture (`/hive:arch`) and metrics. Recommendation: group them in a single conversation to avoid fragmentation.
...
### B. Pipeline next steps

- `/hive:arch docs/design/prd.md` — Technical architecture design
- `/hive:plan docs/design/prd.md` — Development ticket generation

### C. Scope this PRD does **not** define

- **Concrete architectural decisions** (specific stack, models, cloud provider): delegated to the vendor and to the `/hive:arch` phase.
...
*Generated by [Maia](https://github.com/Sateliot/maia) · 2026-05-08 · Deep Think · Claude Opus 4.7 · Claude Code*
